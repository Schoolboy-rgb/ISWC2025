...
# ──────────────────────────────────────────────────────────
zero_tpl = (
  "Answer the following question. Respond with just the name of the televisionshow(s),\n"
  "or 'unsure' if unknown. Do not include any other text.\n\n"
  "Question: {q}\nAnswer:"
)
few_tpl = (
  "Answer the following question with just the name of the televisionshow(s), or 'unsure' if unknown.\n"
  "Do not include any other text.\n\n"
  "Question: What television show did \"Reg Livermore\" star in?\nAnswer: The Mavis Bramston Show\n\n"
  "Question: What television shows did \"Irene Ferri\" star in?\nAnswer: Tutti pazzi per amore, Grandi domani\n\n"
  "Question: {q}\nAnswer:"
)
